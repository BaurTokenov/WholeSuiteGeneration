...
public class TestCaseMutator {
  ...
  public static void mutateTestSuite(TestSuite testSuite) {
    Random r = new Random();
    TestCase testToMutate = testSuite.tests.get(r.nextInt(testSuite.tests.size()));
    mutateTestCase(testToMutate);
  }

  public static void mutateTestCase(TestCase testCase) {
    Random r = new Random();
